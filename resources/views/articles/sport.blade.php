...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">⚽ Sport</h1>
        <p class="text-gray-600 mt-2">Actualités sportives et résultats</p>
    </div>
    ...
    @if($articles->count() == 0)
        <div class="text-center py-8">
            <p class="text-gray-500">Aucun article sportif disponible pour le moment.</p>
        </div>
    @endif
